...
HD_PWD='C:/ddr_test/ddr_test/ddr_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log imp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source imp_top.tcl -notrace
