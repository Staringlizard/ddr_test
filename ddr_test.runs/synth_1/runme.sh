...
HD_PWD='C:/ddr_test/ddr_test/ddr_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imp_top.tcl
